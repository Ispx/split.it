  ...
  Widget build(BuildContext context) {
      return Scaffold(
        body: Container(
          ...
          child: Center()),
          Expanded(child: TitleSubtitleStpesWidget(title: 'Qual ou quais', subtitle: 'ítens você quer dividir?')),
          Expanded(
            child: Padding(
              ...
              child: Expanded(
                child: Row(children: [
                  ...
                  Expanded(
                    flex: 4,
                    child: InputFieldStepsWidget(hintText: 'Picanha')),
                  Expanded(
                    flex: 2,
                    child: InputFieldStepsWidget(hintText: 'R\$ 100,00')),
          ...
          TextButton(onPressed: (){}, child: Row(
            ...
            children: [
              ...
              Text('Adicionar',style: TextStyle(color: Colors.green),),
            ],
          ),
        ),
        Expanded(
